...
def correlation(timestamp: float) -> None:
    ...
    scatter([dataset["bpm"], dataset["streams"]],
            "Streams vs BPM", id=f"{timestamp}",
            x="BPM", y="Streams", s=True)
    scatter([dataset["artist_count"], dataset["streams"]],
            "Streams vs Artiste count", id=f"{timestamp}",
            x="Artist count", y="Streams", s=True)
    scatter([dataset["speechiness_%"], dataset["streams"]],
            "Streams vs Speechiness (%)", id=f"{timestamp}",
            x="Speechiness", y="Streams", s=True)
    scatter([dataset["danceability_%"], dataset["streams"]],
            "Streams vs Danceability (%)", id=f"{timestamp}",
            x="Danceability", y="Streams", s=True)
    scatter([dataset["danceability_%"], dataset["energy_%"]],
            "Energy (%) vs Danceability (%)", id=f"{timestamp}",
            x="Danceability", y="Energy", s=True)
